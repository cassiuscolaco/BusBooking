...
from .models import User, Bus, Book, PaymentTransaction
from django.contrib.auth import authenticate, login, logout
from django.contrib.auth.models import User
from .forms import UserLoginForm, UserRegisterForm, PaymentForm
...
def process_payment(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Dummy payment processing logic (simulate success or failure randomly)
            import random
            ...
            PaymentTransaction.objects.create(amount=amount, status=status)
    ...
    return render(request, 'myapp/payment.html', {'form': form})
